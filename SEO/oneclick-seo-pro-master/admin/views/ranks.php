...
<div class="wrap seo-master-wrap">
    <h1>
        <?php esc_html_e('Rank Tracker', 'oneclick-seo-master'); ?>
        <button type="button" class="page-title-action" id="add-keyword-btn"><?php esc_html_e('Add Keyword', 'oneclick-seo-master'); ?></button>
    </h1>
    ...
    <div class="rank-stats">
        <div class="stat-item">
            ...
            <span class="stat-label"><?php esc_html_e('Total Keywords', 'oneclick-seo-master'); ?></span>
        </div>
        <div class="stat-item">
            <span class="stat-value"><?php echo esc_html($stats['in_top_10']); ?></span>
            <span class="stat-label"><?php esc_html_e('In Top 10', 'oneclick-seo-master'); ?></span>
        </div>
        <div class="stat-item">
            <span class="stat-value"><?php echo esc_html($stats['improved']); ?></span>
            <span class="stat-label"><?php esc_html_e('Improved', 'oneclick-seo-master'); ?></span>
        </div>
        <div class="stat-item">
            <span class="stat-value"><?php echo esc_html($stats['average_position'] ?: '-'); ?></span>
            <span class="stat-label"><?php esc_html_e('Avg. Position', 'oneclick-seo-master'); ?></span>
        </div>
    </div>
    ...
    <table class="wp-list-table widefat striped">
        <thead>
            <tr>
                <th><?php esc_html_e('Keyword', 'oneclick-seo-master'); ?></th>
                <th><?php esc_html_e('Position', 'oneclick-seo-master'); ?></th>
                <th><?php esc_html_e('Change', 'oneclick-seo-master'); ?></th>
                <th><?php esc_html_e('Target URL', 'oneclick-seo-master'); ?></th>
                <th><?php esc_html_e('Last Checked', 'oneclick-seo-master'); ?></th>
                <th><?php esc_html_e('Actions', 'oneclick-seo-master'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php if (empty($keywords)): ?>
            <tr><td colspan="6"><?php esc_html_e('No keywords tracked', 'oneclick-seo-master'); ?></td></tr>
            <?php else: ?>
            ...
            <tr data-id="<?php echo esc_attr($kw->id); ?>">
                ...
                <td>
                    ...
                    <?php else: ?>
                    <span class="not-ranked"><?php esc_html_e('Not ranked', 'oneclick-seo-master'); ?></span>
                    <?php endif; ?>
                </td>
                <td>
                ...
                <td>
                    <button type="button" class="button button-small check-rank" data-id="<?php echo esc_attr($kw->id); ?>"><?php esc_html_e('Check', 'oneclick-seo-master'); ?></button>
                    <button type="button" class="button button-small view-history" data-id="<?php echo esc_attr($kw->id); ?>"><?php esc_html_e('History', 'oneclick-seo-master'); ?></button>
                    <button type="button" class="button button-small remove-keyword" data-id="<?php echo esc_attr($kw->id); ?>"><?php esc_html_e('Remove', 'oneclick-seo-master'); ?></button>
                </td>
            </tr>
            <?php endforeach; ?>
            <?php endif; ?>
...
<div id="add-keyword-modal" class="seo-master-modal" style="display: none;">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h2><?php esc_html_e('Add Keyword', 'oneclick-seo-master'); ?></h2>
            <button type="button" class="modal-close">&times;</button>
        </div>
        <div class="modal-body">
            <form id="add-keyword-form">
                <p>
                    <label><?php esc_html_e('Keyword', 'oneclick-seo-master'); ?> *</label>
                    <input type="text" name="keyword" required class="regular-text">
                </p>
                <p>
                    <label><?php esc_html_e('Target URL', 'oneclick-seo-master'); ?></label>
                    <input type="url" name="target_url" class="regular-text" placeholder="https://...">
                </p>
                <p>
                    <label><?php esc_html_e('Country', 'oneclick-seo-master'); ?></label>
                    <select name="country">
                ...
                <p>
                    <label><?php esc_html_e('Device', 'oneclick-seo-master'); ?></label>
                    <select name="device">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="button button-primary" id="submit-keyword"><?php esc_html_e('Add & Check Rank', 'oneclick-seo-master'); ?></button>
        </div>
    </div>
</div>
...
<div id="history-modal" class="seo-master-modal" style="display: none;">
    ...
    <div class="modal-content modal-wide">
        <div class="modal-header">
            <h2><?php esc_html_e('Rank History', 'oneclick-seo-master'); ?></h2>
            <button type="button" class="modal-close">&times;</button>
        </div>
        <div class="modal-body">
...
jQuery(document).ready(function($) {
    ...
    $('#submit-keyword').on('click', function() {
        ...
        $btn.prop('disabled', true).text('<?php esc_html_e('Checking...', 'oneclick-seo-master'); ?>');
        ...
        $.post(seoMaster.ajaxUrl, {
            ...
            $btn.prop('disabled', false).text('<?php esc_html_e('Add & Check Rank', 'oneclick-seo-master'); ?>');
        });
    });
    ...
    $('.check-rank').on('click', function() {
        ...
        $.post(seoMaster.ajaxUrl, {
            ...
            $btn.prop('disabled', false).text('<?php esc_html_e('Check', 'oneclick-seo-master'); ?>');
        });
    });
    ...
    function renderHistoryChart(history) {
        ...
        historyChart = new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php esc_html_e('Position', 'oneclick-seo-master'); ?>',
                    data: data,
                    borderColor: '#2271b1',
                    tension: 0.3,
                    fill: false
            ...
            options: {
                ...
                scales: {
                    y: {
                        reverse: true,
                        min: 1,
                        title: { display: true, text: '<?php esc_html_e('Position', 'oneclick-seo-master'); ?>' }
                    }
                }
            }
        });
    ...
    $('.remove-keyword').on('click', function() {
        if (!confirm('<?php esc_html_e('Remove this keyword?', 'oneclick-seo-master'); ?>')) return;
