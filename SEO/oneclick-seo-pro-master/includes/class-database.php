...
class OneClick_SEO_Master_Database {
    ...
    public function create_tables() {
        ...
        // Licenses table
        $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}oneclick_master_licenses (
        ...
        $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}oneclick_master_activations (
            id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
        ...
        $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}oneclick_master_remote_sites (
            id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
            site_url varchar(255) NOT NULL,
            site_name varchar(100),
        ...
        // Keywords table
        $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}oneclick_master_keywords (
            id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
        ...
        // Rank history table
        $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}oneclick_master_rank_history (
            id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
        ...
        // SEO audits table
        $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}oneclick_master_audits (
            id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
        ...
        // Bulk changes queue
        $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}oneclick_master_bulk_queue (
            id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
            site_id bigint(20) unsigned NOT NULL,
        ...
        if (function_exists('update_option')) {
            update_option('oneclick_oneclick_master_db_version', self::DB_VERSION);
        }
    }

    private function maybe_upgrade() {
        $installed = get_option('oneclick_oneclick_master_db_version', '0');
    ...
    public function get_table($name) {
        global $wpdb;
        return $wpdb->prefix . 'oneclick_master_' . $name;
    }
}
