...
class OneClick_SEO_Pro_FAQ_Generator {
    ...
    public function __construct() {
        $this->settings = get_option('oneclick_seo_pro_faq', [
            'auto_generate' => false,
            'min_questions' => 5,
            'max_questions' => 10,
            'use_ai' => true,
  ...
  ...
    ...
    public function generate_faq_html($faq_items, $options = []) {
        ...
        $options = wp_parse_args($options, [
            ...
            'schema' => true,
            'heading_tag' => 'h3',
            'container_class' => 'oneclick-seo-pro-faq',
        ]);

        $html = '<div class="' . esc_attr($options['container_class']) . '">';
        $html .= '<h2>' . esc_html__('Frequently Asked Questions', 'oneclick-seo-pro') . '</h2>';
    ...
    private function get_faq_styles() {
        return '<style>
            .oneclick-seo-pro-faq { margin: 2em 0; }
            .oneclick-seo-pro-faq h2 { margin-bottom: 1em; }
    ...
    public function save_to_post($post_id, $faq_items) {
        update_post_meta($post_id, '_oneclick_seo_pro_faq_items', $faq_items);
    }
    ...
    public function get_from_post($post_id) {
        return get_post_meta($post_id, '_oneclick_seo_pro_faq_items', true) ?: [];
    }
