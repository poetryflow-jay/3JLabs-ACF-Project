...
class OneClick_SEO_Pro_AI_Engine {
    ...
    public function __construct() {
        $this->provider = get_option('oneclick_seo_pro_ai_provider', 'openai');
        $this->api_key = get_option('oneclick_seo_pro_ai_api_key', '');
        $this->model = get_option('oneclick_seo_pro_ai_model', 'gpt-4o-mini');
    }
