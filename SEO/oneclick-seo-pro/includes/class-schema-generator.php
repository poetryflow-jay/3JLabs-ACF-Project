...
class OneClick_SEO_Pro_Schema_Generator {
    ...
    private function load_settings() {
        $this->organization = get_option('oneclick_seo_pro_organization', [
    ...
    public function output_schema() {
        ...
        // Filter schemas
        $schemas = apply_filters('oneclick_seo_pro_schemas', $schemas);
    ...
    public function generate_search_results_schema() {
        ...
        return [
            ...
            'name' => sprintf(__('Search Results for: %s', 'oneclick-seo-pro'), get_search_query()),
            'url' => get_search_link(),
            'mainEntity' => [
                '@type' => 'ItemList',
    ...
    public function add_custom_schema($schema) {
        add_filter('oneclick_seo_pro_schemas', function($schemas) use ($schema) {
            $schemas[] = $schema;
            return $schemas;
        });
    }
