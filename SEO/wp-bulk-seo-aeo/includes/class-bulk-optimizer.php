<?php
/**
 * WP Bulk SEO & AEO - Bulk Optimizer
 *
...
class WP_Bulk_SEO_AEO_Bulk_Optimizer {
    ...
    private function save_issues($post_id, $score_result) {
        ...
        $table = $wpdb->prefix . 'bulk_seo_aeo_issues';
    ...
    private function log_operation_start($operation, $total) {
        ...
        $wpdb->insert($wpdb->prefix . 'bulk_seo_aeo_log', [
    ...
    public function run_scheduled_analysis() {
        if (!get_option('wp_bulk_seo_aeo_auto_analyze', true)) {
            return;
        }
