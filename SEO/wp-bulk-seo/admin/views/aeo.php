...
?>
<div class="wrap wp-bulk-seo-aeo">
    <h1><?php esc_html_e('Answer Engine Optimization (AEO)', 'wp-bulk-seo'); ?></h1>

    <p class="description">
        <?php esc_html_e('Optimize your content for AI-powered search engines like ChatGPT, Perplexity, Claude, and Google SGE.', 'wp-bulk-seo'); ?>
    </p>
    ...
    <div class="aeo-overview">
        <div class="aeo-card">
            ...
            <div class="aeo-content">
                <h3><?php esc_html_e('Conversational Readiness', 'wp-bulk-seo'); ?></h3>
                <div class="aeo-score" id="conversational-score">--</div>
                <p><?php esc_html_e('How well your content answers natural language questions', 'wp-bulk-seo'); ?></p>
            </div>
        </div>
        ...
        <div class="aeo-card">
            ...
            <div class="aeo-content">
                <h3><?php esc_html_e('FAQ Coverage', 'wp-bulk-seo'); ?></h3>
                <div class="aeo-score" id="faq-score">--</div>
                <p><?php esc_html_e('Question-answer structured content availability', 'wp-bulk-seo'); ?></p>
            </div>
        </div>
        ...
        <div class="aeo-card">
            ...
            <div class="aeo-content">
                <h3><?php esc_html_e('Snippet Potential', 'wp-bulk-seo'); ?></h3>
                <div class="aeo-score" id="snippet-score">--</div>
                <p><?php esc_html_e('Likelihood of appearing in featured snippets', 'wp-bulk-seo'); ?></p>
            </div>
        </div>
        ...
        <div class="aeo-card">
            ...
            <div class="aeo-content">
                <h3><?php esc_html_e('Citation Worthiness', 'wp-bulk-seo'); ?></h3>
                <div class="aeo-score" id="citation-score">--</div>
                <p><?php esc_html_e('How likely AI will cite your content as a source', 'wp-bulk-seo'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="aeo-section">
        <h2><?php esc_html_e('Content AEO Analysis', 'wp-bulk-seo'); ?></h2>

        <div class="aeo-analyzer">
            <div class="analyzer-controls">
                <select id="aeo-post-select" class="regular-text">
                    <option value=""><?php esc_html_e('Select a post to analyze...', 'wp-bulk-seo'); ?></option>
                </select>
                <button type="button" id="analyze-aeo" class="button button-primary" disabled>
                    <span class="dashicons dashicons-search"></span>
                    <?php esc_html_e('Analyze AEO', 'wp-bulk-seo'); ?>
                </button>
            </div>
            ...
            <div class="aeo-results" style="display: none;">
                <div class="results-header">
                    ...
                    <div class="overall-aeo-score">
                        <span class="score-label"><?php esc_html_e('AEO Score', 'wp-bulk-seo'); ?></span>
                ...
                <div class="results-grid">
                    ...
                    <div class="results-card factors-card">
                        <h4><?php esc_html_e('AEO Factors', 'wp-bulk-seo'); ?></h4>
                        <div class="factors-list" id="aeo-factors"></div>
                    </div>

                    <!-- Recommendations -->
                    <div class="results-card recommendations-card">
                        <h4><?php esc_html_e('Recommendations', 'wp-bulk-seo'); ?></h4>
    ...
    <div class="aeo-section">
        <h2><?php esc_html_e('FAQ Generator', 'wp-bulk-seo'); ?></h2>
        <p class="description">
            <?php esc_html_e('Generate FAQ schema markup to improve your chances of appearing in AI search results.', 'wp-bulk-seo'); ?>
        </p>

        <div class="faq-generator">
            <div class="generator-controls">
                <select id="faq-post-select" class="regular-text">
                    <option value=""><?php esc_html_e('Select a post...', 'wp-bulk-seo'); ?></option>
                </select>

                <div class="generator-options">
                    <label>
                        <input type="checkbox" id="faq-extract-existing" checked>
                        <?php esc_html_e('Extract existing Q&A from content', 'wp-bulk-seo'); ?>
                    </label>
                    <label>
                        <input type="checkbox" id="faq-generate-ai" <?php checked(!empty($aeo_settings['auto_generate_faq'])); ?>>
                        <?php esc_html_e('Generate additional FAQs with AI', 'wp-bulk-seo'); ?>
                    </label>
                </div>

                <button type="button" id="generate-faq" class="button button-primary" disabled>
                    <span class="dashicons dashicons-plus-alt"></span>
                    <?php esc_html_e('Generate FAQ', 'wp-bulk-seo'); ?>
                </button>
            </div>

            <div class="faq-preview" style="display: none;">
                <h4><?php esc_html_e('Generated FAQ Items', 'wp-bulk-seo'); ?></h4>
                <div class="faq-items" id="faq-items"></div>

                <div class="faq-actions">
                    <button type="button" id="add-faq-item" class="button">
                        <span class="dashicons dashicons-plus"></span>
                        <?php esc_html_e('Add FAQ Item', 'wp-bulk-seo'); ?>
                    </button>
                    <button type="button" id="save-faq" class="button button-primary">
                        <span class="dashicons dashicons-saved"></span>
                        <?php esc_html_e('Save FAQ Schema', 'wp-bulk-seo'); ?>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="aeo-section">
        <h2><?php esc_html_e('Featured Snippet Optimizer', 'wp-bulk-seo'); ?></h2>
        <p class="description">
            <?php esc_html_e('Optimize your content structure to win featured snippets (position zero).', 'wp-bulk-seo'); ?>
        </p>
        ...
        <div class="snippet-optimizer">
            <div class="optimizer-controls">
                ...
                <button type="button" id="analyze-snippets" class="button button-primary" disabled>
                    ...
                    <?php esc_html_e('Analyze Snippet Potential', 'wp-bulk-seo'); ?>
                </button>
            </div>
                ...
                <div class="snippet-types">
                    <div class="snippet-type" data-type="paragraph">
                        ...
                        <div class="snippet-info">
                            <h5><?php esc_html_e('Paragraph Snippet', 'wp-bulk-seo'); ?></h5>
                    ...
                    <div class="snippet-type" data-type="list">
                        ...
                        <div class="snippet-info">
                            <h5><?php esc_html_e('List Snippet', 'wp-bulk-seo'); ?></h5>
                    ...
                    <div class="snippet-type" data-type="table">
                        ...
                        <div class="snippet-info">
                            <h5><?php esc_html_e('Table Snippet', 'wp-bulk-seo'); ?></h5>
                    ...
                    <div class="snippet-type" data-type="steps">
                        ...
                        <div class="snippet-info">
                            <h5><?php esc_html_e('How-to Steps', 'wp-bulk-seo'); ?></h5>
    ...
    <!-- Bulk AEO Analysis -->
    <div class="aeo-section">
        <h2><?php esc_html_e('Bulk AEO Analysis', 'wp-bulk-seo'); ?></h2>

        <div class="bulk-aeo-controls">
            <select id="bulk-post-type" class="regular-text">
                <option value="post"><?php esc_html_e('Posts', 'wp-bulk-seo'); ?></option>
                <option value="page"><?php esc_html_e('Pages', 'wp-bulk-seo'); ?></option>
                <?php
            ...
            <button type="button" id="run-bulk-aeo" class="button button-primary">
                ...
                <?php esc_html_e('Run Bulk Analysis', 'wp-bulk-seo'); ?>
            </button>
        </div>

        <div class="bulk-progress" style="display: none;">
            <div class="progress-info">
                <span class="progress-text"><?php esc_html_e('Analyzing...', 'wp-bulk-seo'); ?></span>
        ...
        <table class="wp-list-table widefat striped" id="bulk-aeo-table" style="display: none;">
            <thead>
                <tr>
                    ...
                    <th><?php esc_html_e('AEO Score', 'wp-bulk-seo'); ?></th>
                    <th><?php esc_html_e('FAQ', 'wp-bulk-seo'); ?></th>
                    <th><?php esc_html_e('Snippet', 'wp-bulk-seo'); ?></th>
                    <th><?php esc_html_e('Conversational', 'wp-bulk-seo'); ?></th>
...
<div class="faq-item" data-index="{{index}}">
    <div class="faq-item-header">
        ...
        <button type="button" class="faq-remove" title="<?php esc_attr_e('Remove', 'wp-bulk-seo'); ?>">&times;</button>
    </div>
    <div class="faq-fields">
        <div class="faq-field">
            <label><?php esc_html_e('Question', 'wp-bulk-seo'); ?></label>
            <input type="text" class="faq-question large-text" value="{{question}}">
        </div>
        <div class="faq-field">
            <label><?php esc_html_e('Answer', 'wp-bulk-seo'); ?></label>
...
jQuery(document).ready(function($) {
    ...
    function loadPostsForSelect() {
        $.post(wpBulkSeo.ajaxUrl, {
            action: 'wp_bulk_seo_get_posts_simple',
            nonce: wpBulkSeo.nonce
        }).done(function(response) {
            if (response.success) {
                var options = '<option value=""><?php esc_html_e('Select a post...', 'wp-bulk-seo'); ?></option>';
    ...
    $('#analyze-aeo').on('click', function() {
        ...
        $.post(wpBulkSeo.ajaxUrl, {
            action: 'wp_bulk_seo_analyze_aeo',
            nonce: wpBulkSeo.nonce,
            post_id: postId
        }).done(function(response) {
            if (response.success) {
                ...
                alert(response.data.message || '<?php esc_html_e('Analysis failed', 'wp-bulk-seo'); ?>');
            }
        }).always(function() {
    ...
    function displayAEOResults(data) {
        ...
        if (data.recommendations && data.recommendations.length) {
            ...
            recsHtml = '<li class="no-recs"><?php esc_html_e('Great job! No major improvements needed.', 'wp-bulk-seo'); ?></li>';
        }
    ...
    $('#generate-faq').on('click', function() {
        ...
        $.post(wpBulkSeo.ajaxUrl, {
            ...
            if (response.success) {
                ...
                alert(response.data.message || '<?php esc_html_e('Generation failed', 'wp-bulk-seo'); ?>');
            }
        }).always(function() {
            $btn.prop('disabled', false);
            $btn.find('.dashicons').removeClass('spin');
    ...
    $('#save-faq').on('click', function() {
        ...
        if (validFaqs.length === 0) {
            alert('<?php esc_html_e('Please add at least one FAQ with both question and answer.', 'wp-bulk-seo'); ?>');
            return;
        }
        ...
        $.post(wpBulkSeo.ajaxUrl, {
            action: 'wp_bulk_seo_save_faq',
            nonce: wpBulkSeo.nonce,
            post_id: postId,
            faqs: JSON.stringify(validFaqs)
        }).done(function(response) {
            if (response.success) {
                alert('<?php esc_html_e('FAQ schema saved successfully!', 'wp-bulk-seo'); ?>');
            } else {
                alert(response.data.message || '<?php esc_html_e('Save failed', 'wp-bulk-seo'); ?>');
            }
        }).always(function() {
            $btn.prop('disabled', false);
        });
    ...
    $('#analyze-snippets').on('click', function() {
        ...
        $.post(wpBulkSeo.ajaxUrl, {
            action: 'wp_bulk_seo_analyze_snippets',
            nonce: wpBulkSeo.nonce,
            post_id: postId
        }).done(function(response) {
            if (response.success) {
    ...
    function displaySnippetResults(data) {
        ...
        if (data.suggestions && data.suggestions.length) {
            suggestionsHtml = '<h4><?php esc_html_e('Improvement Suggestions', 'wp-bulk-seo'); ?></h4><ul>';
    ...
    $('#run-bulk-aeo').on('click', function() {
        ...
        $.post(wpBulkSeo.ajaxUrl, {
            action: 'wp_bulk_seo_get_posts_for_aeo',
            nonce: wpBulkSeo.nonce,
            post_type: postType
        }).done(function(response) {
            if (response.success && response.data.length) {
                ...
                alert('<?php esc_html_e('No posts found', 'wp-bulk-seo'); ?>');
                $btn.prop('disabled', false);
                $('.bulk-progress').hide();
            }
        });
    ...
    function addBulkResultRow(post, data) {
        ...
        var row = '<tr>' +
            ...
            '<td>' +
                '<button type="button" class="button button-small view-aeo-details" data-post-id="' + post.id + '"><?php esc_html_e('Details', 'wp-bulk-seo'); ?></button>' +
            '</td>' +
        '</tr>';
