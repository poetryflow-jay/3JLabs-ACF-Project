...
class WP_Bulk_SEO_Ranking_Factors_DB {
    ...
    /**
     * Get module factors (alias for get_module)
     * Supports both static and instance calls
     */
    public function get_module_factors($module_name) {
        return self::get_module($module_name);
    }

    /**
     * Get module factors (static version)
     */
    public static function get_module_factors_static($module_name) {
        return self::get_module($module_name);
    }
