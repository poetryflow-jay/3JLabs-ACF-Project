...
class WP_Bulk_SEO_Scorer {
    ...
    public function __construct() {
        // Use static methods, but create instance for compatibility
    ...
    private function score_lighthouse($data) {
        $factors = $this->factors_db->get_module_factors('Lighthouse') ?: WP_Bulk_SEO_Ranking_Factors_DB::get_module('Lighthouse');
        $scored_factors = [];
        $total_score = 0;
        $total_weight = 0;
    ...
    private function get_priority_label($priority_const) {
        $map = [
            WP_Bulk_SEO_Ranking_Factors_DB::PRIORITY_P0 => 'P0',
            WP_Bulk_SEO_Ranking_Factors_DB::PRIORITY_P1 => 'P1',
            WP_Bulk_SEO_Ranking_Factors_DB::PRIORITY_P2 => 'P2',
            WP_Bulk_SEO_Ranking_Factors_DB::PRIORITY_P3 => 'P3',
        ];
