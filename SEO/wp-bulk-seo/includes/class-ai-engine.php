...
class WP_Bulk_SEO_AI_Engine {
    ...
    public function __construct() {
        $this->provider = get_option('wp_bulk_seo_ai_provider', 'openai');
        $this->api_key = get_option('wp_bulk_seo_ai_api_key', '');
        $this->model = get_option('wp_bulk_seo_ai_model', 'gpt-4o-mini');
    }
