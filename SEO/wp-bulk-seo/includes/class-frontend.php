...
class WP_Bulk_SEO_Frontend {
    ...
    public function output_meta_tags() {
        ...
        $post_id = get_the_ID();
        $description = get_post_meta($post_id, '_wp_bulk_seo_description', true);
    ...
    public function output_canonical() {
        ...
        $post_id = get_the_ID();
        $canonical = get_post_meta($post_id, '_wp_bulk_seo_canonical', true);
    ...
    public function output_open_graph() {
        ...
        // Title
        $og_title = get_post_meta($post_id, '_wp_bulk_seo_title', true) ?: get_the_title($post_id);
        echo '<meta property="og:title" content="' . esc_attr($og_title) . '">' . "\n";

        // Description
        $og_description = get_post_meta($post_id, '_wp_bulk_seo_description', true);
    ...
    public function output_twitter_cards() {
        ...
        // Title
        $title = get_post_meta($post_id, '_wp_bulk_seo_title', true) ?: get_the_title($post_id);
    ...
    public function filter_robots($robots) {
        ...
        $post_id = get_the_ID();
        $robots_meta = get_post_meta($post_id, '_wp_bulk_seo_robots', true);
    ...
    private function get_og_image($post_id) {
        // Custom OG image
        $og_image = get_post_meta($post_id, '_wp_bulk_seo_og_image', true);
        if (!empty($og_image)) {
            return $og_image;
        }
