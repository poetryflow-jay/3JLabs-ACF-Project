...
3J Labs 플러그인 패밀리의 라이센스 인증, 자동 업데이트, 원격 제어를 담당하는 중앙 관리 시스템입니다. **개발자 전용 플러그인**으로, WordPress 기반 플러그인 판매 웹사이트를 위한 완전한 라이센스 관리 솔루션을 제공합니다.

## ⚠️ 중요: 사용 대상

**Neural Link는 개발자 전용 플러그인입니다.**
- 일반 사용자(free, basic, premium, unlimited 버전 소유자)는 Neural Link를 사용할 필요가 없습니다
- 개발자/마스터 버전 소유자만 Neural Link를 사용합니다

## 최근 변경 사항

### v8.0.0 (2026-01-05) - 다중 플러그인 배포 관리 시스템
- **14개 플러그인 중앙 관리**: ACF CSS, WP Bulk Manager, Nudge Flow 등
- **카드 기반 배포 관리 UI**: 에디션별 버전/URL 관리
- **플러그인명 변경**: "ACF CSS Neural Link" → "3J Neural Link"
- **메뉴명 변경**: "JJ Licenses" → "3J 라이센스 관리 🔑"
- **빌드 시스템 개선**: 13개 플러그인 통합 빌드

### v3.1.0 (2025-12-18)
- Neural Link Platform Sync
- OTA 업데이트 파이프라인 기반 구축
