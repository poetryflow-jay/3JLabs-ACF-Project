...
if ( ! defined( 'JJ_STYLE_GUIDE_VERSION' ) ) {
    define( 'JJ_STYLE_GUIDE_VERSION', '13.4.5' ); // [v13.4.5] Admin Center 빈 화면 해결 + Menu Editor 통합 + CSS/JS 폴백 추가
}
...
try {
    ...
    // [Phase 19] Master Integrator - 마스터 버전 올인원 통합 로더
    // 마스터 버전에서 모든 패밀리 플러그인 기능을 단일 플러그인에 통합
    $jj_safe_require( JJ_STYLE_GUIDE_PATH . 'includes/class-jj-master-integrator.php', false );
