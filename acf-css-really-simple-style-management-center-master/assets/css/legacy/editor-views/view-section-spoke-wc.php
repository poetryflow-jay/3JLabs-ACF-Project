    ...
    <div class="jj-tabs-container">
        ...
        <div class="jj-tab-content is-active" data-tab-content="wc-single">
            ...
            <fieldset class="jj-fieldset-group">
                <legend><?php _e( '상품명 (Product Title)', 'jj-style-guide' ); ?></legend>
                
                <div class="jj-control-group jj-control-toggle">
                    <label for="jj-wc-single-title-override"><?php _e( '타이포그래피 재정의', 'jj-style-guide' ); ?></label>
                    ...
                    <p class="description"><?php _e( '기본값: \'2. 전역 타이포그래피\'의 H1 스타일을 따름', 'jj-style-guide' ); ?></p>
                </div>
                ...
                <div class="jj-control-group jj-control-toggle jj-toggle-sub">
                    ...
                    <p class="description"><?php _e( '기본값: 테마의 H1 색상을 따름', 'jj-style-guide' ); ?></p>
                </div>
                
                <div class="jj-toggled-controls" id="jj-wc-single-title-color-controls">
                    <div class="jj-control-group"><label><?php _e( '색상 (Normal & Hover)', 'jj-style-guide' ); ?></label><div class="jj-color-group"><input type="text" class="jj-color-field jj-data-field" data-setting-key="contexts[woocommerce][single_product][title_color]" value="<?php echo esc_attr( $wc_single['title_color'] ?? '' ); ?>" /><input type="text" class="jj-color-field jj-data-field" data-setting-key="contexts[woocommerce][single_product][title_color_hover]" value="<?php echo esc_attr( $wc_single['title_color_hover'] ?? '' ); ?>" /></div></div>
                </div>
            </fieldset>

            <fieldset class="jj-fieldset-group">
                <legend><?php _e( '가격 (Product Price)', 'jj-style-guide' ); ?></legend>
                
                <div class="jj-control-group jj-control-toggle">
                    <label for="jj-wc-single-price-override"><?php _e( '타이포그래피 재정의', 'jj-style-guide' ); ?></label>
                    ...
                    <p class="description"><?php _e( '기본값: \'2. 전역 타이포그래피\'의 P 스타일을 따름', 'jj-style-guide' ); ?></p>
                </div>
                ...
                <div class="jj-control-group jj-control-toggle jj-toggle-sub">
                    <label for="jj-wc-single-price-color-override"><?php _e( '색상 재정의', 'jj-style-guide' ); ?></label>
                    ...
                    <p class="description"><?php _e( '기본값: 테마의 가격 색상을 따름', 'jj-style-guide' ); ?></p>
                </div>
                
                <div class="jj-toggled-controls" id="jj-wc-single-price-color-controls">
                    <div class="jj-control-group"><label><?php _e( '색상 (Normal)', 'jj-style-guide' ); ?></label><div class="jj-color-group" style="grid-template-columns: 1fr;"><input type="text" class="jj-color-field jj-data-field" data-setting-key="contexts[woocommerce][single_product][price_color]" value="<?php echo esc_attr( $wc_single['price_color'] ?? '' ); ?>" /></div></div>
                </div>
            </fieldset>

            <fieldset class="jj-fieldset-group">
                <legend><?php _e( '\'장바구니 담기\' 버튼 (Add to Cart)', 'jj-style-guide' ); ?></legend>
                
                <div class="jj-control-group">
                    <label for="jj-wc-single-button-text"><?php _e( '버튼 텍스트 (Text)', 'jj-style-guide' ); ?></label>
                    ...
                    <p class="description"><?php _e( '상품 페이지의 \'담기\' 버튼 텍스트를 변경합니다.', 'jj-style-guide' ); ?></p>
                </div>
                 
                <div class="jj-control-group jj-control-toggle">
                    <label for="jj-wc-single-button-override"><?php _e( '버튼 스타일 재정의', 'jj-style-guide' ); ?></label>
                    ...
                    <p class="description"><?php _e( '기본값: \'3. 전역 버튼\'의 Primary Button 스타일을 따름', 'jj-style-guide' ); ?></p>
                </div>
                ...
                <div class="jj-toggled-controls" id="jj-wc-single-button-controls">
                    ...
                    ?>
                    <fieldset class="jj-control-group jj-fieldset-group"><legend><?php _e( 'Colors', 'jj-style-guide' ); ?></legend><div class="jj-control-group"><label><?php _e( '배경 색상 (Normal & Hover)', 'jj-style-guide' ); ?></label><div class="jj-color-group"><input type="text" class="jj-color-field jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[background_color]" value="<?php echo esc_attr( $btn_options['background_color'] ?? '' ); ?>" /><input type="text" class="jj-color-field jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[background_color_hover]" value="<?php echo esc_attr( $btn_options['background_color_hover'] ?? '' ); ?>" /></div></div><div class="jj-control-group"><label><?php _e( '텍스트 색상 (Normal & Hover)', 'jj-style-guide' ); ?></label><div class="jj-color-group"><input type="text" class="jj-color-field jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[text_color]" value="<?php echo esc_attr( $btn_options['text_color'] ?? '' ); ?>" /><input type="text" class="jj-color-field jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[text_color_hover]" value="<?php echo esc_attr( $btn_options['text_color_hover'] ?? '' ); ?>" /></div></div><div class="jj-control-group"><label><?php _e( '테두리 색상 (Normal & Hover)', 'jj-style-guide' ); ?></label><div class="jj-color-group"><input type="text" class="jj-color-field jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[border_color]" value="<?php echo esc_attr( $btn_options['border_color'] ?? '' ); ?>" /><input type="text" class="jj-color-field jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[border_color_hover]" value="<?php echo esc_attr( $btn_options['border_color_hover'] ?? '' ); ?>" /></div></div></fieldset>
                    <fieldset class="jj-control-group jj-fieldset-group jj-grid-2-col"><legend><?php _e( 'Layout', 'jj-style-guide' ); ?></legend><div class="jj-control-group"><label for="jj-wc-btn-border-radius"><?php _e( 'Border Radius (px)', 'jj-style-guide' ); ?></label><input type="number" id="jj-wc-btn-border-radius" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[border_radius]" value="<?php echo esc_attr( $btn_options['border_radius'] ?? '' ); ?>" placeholder="예: 4" /></div><div class="jj-control-group"><label><?php _e( 'Padding (px)', 'jj-style-guide' ); ?></label><div class="jj-dimensions-group"><input type="number" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[padding][top]" value="<?php echo esc_attr( $btn_options['padding']['top'] ?? '' ); ?>" title="Top" placeholder="Top"><input type="number" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[padding][right]" value="<?php echo esc_attr( $btn_options['padding']['right'] ?? '' ); ?>" title="Right" placeholder="Right"><input type="number" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[padding][bottom]" value="<?php echo esc_attr( $btn_options['padding']['bottom'] ?? '' ); ?>" title="Bottom" placeholder="Bottom"><input type="number" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[padding][left]" value="<?php echo esc_attr( $btn_options['padding']['left'] ?? '' ); ?>" title="Left" placeholder="Left"></div></div></fieldset>
                    <fieldset class="jj-control-group jj-fieldset-group"><legend><?php _e( 'Button Shadow', 'jj-style-guide' ); ?></legend><div class="jj-shadow-group"><div class="jj-control-group"><label><?php _e( 'Color', 'jj-style-guide' ); ?></label><input type="text" class="jj-color-field jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[shadow][color]" value="<?php echo esc_attr( $btn_options['shadow']['color'] ?? '' ); ?>" /></div><div class="jj-control-group"><label><?php _e( 'X Offset (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[shadow][x]" value="<?php echo esc_attr( $btn_options['shadow']['x'] ?? '' ); ?>" placeholder="0"></div><div class="jj-control-group"><label><?php _e( 'Y Offset (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[shadow][y]" value="<?php echo esc_attr( $btn_options['shadow']['y'] ?? '' ); ?>" placeholder="10"></div><div class="jj-control-group"><label><?php _e( 'Blur (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[shadow][blur]" value="<?php echo esc_attr( $btn_options['shadow']['blur'] ?? '' ); ?>" placeholder="15"></div><div class="jj-control-group"><label><?php _e( 'Spread (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="<?php echo esc_attr( $prefix ); ?>[shadow][spread]" value="<?php echo esc_attr( $btn_options['shadow']['spread'] ?? '' ); ?>" placeholder="-5"></div></div></fieldset>
                </div>
            </fieldset>
        </div>

        <div class="jj-tab-content" data-tab-content="wc-archive">
            <p class="description"><?php _e( 'v1.9.0 정식 버전에서 \'상품 아카이브\' 페이지의 상세 제어 기능이 추가될 예정입니다.', 'jj-style-guide' ); ?></p>
        </div>
        
        <div class="jj-tab-content" data-tab-content="wc-shop-kit">
            <fieldset class="jj-fieldset-group">
                <legend><?php _e( 'Kadence Shop Kit 스타일', 'jj-style-guide' ); ?></legend>
                <div class="jj-style-guide-grid jj-grid-4-col">
                    
                    <div class="jj-control-group jj-color-card">
                        <label for="jj-wc-shop-kit-quick-view-bg"><?php _e( 'Quick View 버튼 배경', 'jj-style-guide' ); ?></label>
                        <input type="text" 
        ...
        <div class="jj-tab-content" data-tab-content="wc-korea">
            <fieldset class="jj-fieldset-group">
                <legend><?php _e( 'WooCommerce K (단비스토어) 스타일', 'jj-style-guide' ); ?></legend>
                <div class="jj-style-guide-grid jj-grid-4-col">
                    
                    <div class="jj-control-group jj-color-card">
                        <label for="jj-wc-korea-naver-pay"><?php _e( '네이버페이 버튼 배경', 'jj-style-guide' ); ?></label>
                        <input type="text" 
                    ...
                    <div class="jj-control-group jj-color-card">
                        <label for="jj-wc-korea-kakao-pay"><?php _e( '카카오페이 버튼 배경', 'jj-style-guide' ); ?></label>
                        <input type="text" 
