...
<div class="jj-admin-center-tab-content" data-tab="backup">
    <h3><?php esc_html_e( '백업 및 복원', 'jj-style-guide' ); ?></h3>
    <p class="description">
        <?php esc_html_e( '플러그인 설정을 백업하고 복원할 수 있습니다. 자동 백업은 매일, 주간, 월간으로 자동 생성됩니다.', 'jj-style-guide' ); ?>
    </p>

    <div class="jj-backup-controls" style="margin-bottom: 25px;">
        <h4><?php esc_html_e( '백업 생성', 'jj-style-guide' ); ?></h4>
        <div style="display: flex; gap: 10px; align-items: center;">
            <input type="text" 
                   id="jj-backup-label-input" 
                   placeholder="<?php esc_attr_e( '백업 레이블 (선택사항)', 'jj-style-guide' ); ?>"
                   class="regular-text" 
                   style="width: 300px;" />
            <button type="button" class="button button-primary" id="jj-create-backup-btn">
                <?php esc_html_e( '수동 백업 생성', 'jj-style-guide' ); ?>
            </button>
            <span class="spinner jj-backup-spinner" style="float: none; margin-left: 5px; display: none;"></span>
        </div>
        <p class="description" style="margin-top: 10px;">
            <?php esc_html_e( '수동으로 백업을 생성할 수 있습니다. 레이블을 입력하지 않으면 "수동 백업"으로 저장됩니다.', 'jj-style-guide' ); ?>
        </p>
    </div>
    ...
    <div class="jj-backup-settings" style="margin-bottom: 25px; padding: 15px; background: #f9f9f9; border: 1px solid #c3c4c7; border-radius: 4px;">
        <h4><?php esc_html_e( '자동 백업 설정', 'jj-style-guide' ); ?></h4>
        <table class="form-table" role="presentation">
            <tbody>
            <tr>
                <th scope="row"><?php esc_html_e( '설정 변경 시 자동 백업', 'jj-style-guide' ); ?></th>
                <td>
                    <label>
                        <input type="checkbox" 
                        ...
                        <?php esc_html_e( '설정이 변경될 때마다 자동으로 백업 생성', 'jj-style-guide' ); ?>
                    </label>
                    <p class="description">
                        <?php esc_html_e( '이 옵션을 활성화하면 스타일 센터나 Admin Center에서 설정을 변경할 때마다 자동으로 백업이 생성됩니다.', 'jj-style-guide' ); ?>
                    </p>
                </td>
            </tr>
            </tbody>
