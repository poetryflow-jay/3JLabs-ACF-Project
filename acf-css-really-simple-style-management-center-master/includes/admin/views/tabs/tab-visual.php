...
<div class="jj-admin-center-tab-content" data-tab="visual">
    <div class="jj-admin-center-general-form">
        <h3><?php esc_html_e( '비주얼 커맨드 센터', 'jj-style-guide' ); ?></h3>
        <p class="description">
            <?php esc_html_e( '로그인 화면과 관리자 테마를 시각적으로 커스터마이징합니다.', 'jj-style-guide' ); ?>
        </p>

        <div class="jj-visual-section" style="margin-top: 30px;">
            <h4><?php esc_html_e( '🔐 로그인 화면 커스터마이징', 'jj-style-guide' ); ?></h4>
            <table class="form-table" role="presentation">
                <tbody>
                    <tr>
                        <th scope="row">
                            <label for="visual_options_login_logo_url"><?php esc_html_e( '커스텀 로고 URL', 'jj-style-guide' ); ?></label>
                        </th>
                        <td>
                            ...
                            <p class="description"><?php esc_html_e( '로그인 화면의 워드프레스 로고를 대체할 이미지 URL을 입력하세요.', 'jj-style-guide' ); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <label><?php esc_html_e( '배경 및 폼 색상', 'jj-style-guide' ); ?></label>
                        </th>
                        <td>
                            <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                <div class="jj-admin-center-color-input">
                                    <span style="font-size: 12px;"><?php esc_html_e( '배경색', 'jj-style-guide' ); ?></span>
                                    <input type="text" name="visual_options[login_bg_color]" value="<?php echo esc_attr( $login_bg_color ); ?>" class="jj-color-picker">
                                </div>
                                <div class="jj-admin-center-color-input">
                                    <span style="font-size: 12px;"><?php esc_html_e( '폼 배경색', 'jj-style-guide' ); ?></span>
                                ...
                                <div class="jj-admin-center-color-input">
                                    <span style="font-size: 12px;"><?php esc_html_e( '버튼색', 'jj-style-guide' ); ?></span>
