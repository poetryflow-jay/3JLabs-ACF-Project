...
<div class="jj-labs-overrides-tab">
    <h2><?php _e( '수동 CSS 재정의 (Overrides)', 'acf-css-really-simple-style-management-center' ); ?></h2>
    <p class="description jj-labs-tab-description" data-tab-type="overrides" data-tooltip="labs-tab-overrides">
        <?php _e( '스캐너를 통해 발견된 선택자나 직접 지정한 선택자에 전역 스타일 변수를 적용할 수 있습니다. 여기에 입력한 CSS는 사이트 전역에 적용됩니다.', 'acf-css-really-simple-style-management-center' ); ?>
    ...
    <div class="jj-control-group" style="margin-top: 20px;">
        <label for="jj-labs-override-css">
            <strong><?php _e( 'CSS 오버라이드 코드', 'acf-css-really-simple-style-management-center' ); ?></strong>
        </label>
        <p class="description" style="margin-bottom: 10px;">
            <?php _e( '아래 텍스트 영역에 CSS 코드를 입력하세요. 스타일 센터에서 정의한 CSS 변수(--jj-*)를 사용하여 일관된 스타일을 적용할 수 있습니다.', 'acf-css-really-simple-style-management-center' ); ?>
        </p>
        ...
        <div style="margin-top: 15px;">
            <button type="button" class="button button-secondary" id="jj-labs-preview-overrides">
                <?php _e( '미리보기', 'acf-css-really-simple-style-management-center' ); ?>
            </button>
        ...
        <div class="jj-labs-css-variables-reference" style="margin-top: 20px; padding: 15px; background: #f9f9f9; border: 1px solid #c3c4c7; border-radius: 4px;">
            <h4 style="margin-top: 0;"><?php _e( '사용 가능한 CSS 변수', 'acf-css-really-simple-style-management-center' ); ?></h4>
            <p class="description" style="margin-bottom: 10px;">
                <?php _e( '스타일 센터에서 정의한 주요 CSS 변수 목록입니다:', 'acf-css-really-simple-style-management-center' ); ?>
            </p>
            <ul style="margin: 0; padding-left: 20px; font-family: monospace; font-size: 12px;">
                ...
                <li><?php _e( '... 및 기타 변수들', 'acf-css-really-simple-style-management-center' ); ?></li>
            </ul>
        </div>
    </div>
</div>
