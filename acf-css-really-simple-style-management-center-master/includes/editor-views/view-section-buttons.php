...
<div class="jj-section-global" id="jj-section-buttons">
    <h2 class="jj-section-title">
        ...
        <?php endif; ?>
        <?php echo esc_html( jj_style_guide_text( 'section_buttons_title', __( '버튼 (Buttons)', 'jj-style-guide' ) ) ); ?>
    </h2>
    <p class="description">
        <?php
        echo wp_kses_post(
    ...
    <div class="jj-tabs-container">
        <div class="jj-tabs-nav">
            ...
            <button type="button" class="jj-tab-button <?php echo ( $first_enabled_tab === 'btn-primary' ) ? 'is-active' : ''; ?>" data-tab="btn-primary">
                <?php _e( '1. Primary Button', 'jj-style-guide' ); ?>
            </button>
            <?php endif; ?>
            ...
            <button type="button" class="jj-tab-button <?php echo ( $first_enabled_tab === 'btn-secondary' ) ? 'is-active' : ''; ?>" data-tab="btn-secondary">
                <?php _e( '2. Secondary Button', 'jj-style-guide' ); ?>
            </button>
            <?php endif; ?>
            ...
            <button type="button" class="jj-tab-button <?php echo ( $first_enabled_tab === 'btn-text' ) ? 'is-active' : ''; ?>" data-tab="btn-text">
                <?php _e( '3. Text / Outline Button', 'jj-style-guide' ); ?>
            </button>
            <?php endif; ?>
        </div>
        ...
        <div class="jj-tab-content <?php echo ( $first_enabled_tab === 'btn-secondary' ) ? 'is-active' : ''; ?>" data-tab-content="btn-secondary">
            <div class="jj-button-preview-grid">
                <div class="jj-button-preview">
                    <a href="#" class="jj-button-preview-btn jj-preview-secondary" onclick="return false;"><?php _e( 'Secondary Button', 'jj-style-guide' ); ?></a>
                </div>
                ...
                <div class="jj-button-controls">
                    ...
                    <fieldset class="jj-control-group jj-fieldset-group"><legend><?php _e( 'Button Shadow', 'jj-style-guide' ); ?></legend>
                        <div class="jj-shadow-group"><div class="jj-control-group"><label><?php _e( 'Color', 'jj-style-guide' ); ?></label><input type="text" class="jj-color-field jj-data-field" data-setting-key="buttons[secondary][shadow][color]" value="<?php echo esc_attr( $btn_secondary_options['shadow']['color'] ?? '' ); ?>" /></div><div class="jj-control-group"><label><?php _e( 'X Offset (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="buttons[secondary][shadow][x]" value="<?php echo esc_attr( $btn_secondary_options['shadow']['x'] ?? '' ); ?>" placeholder="0"></div><div class="jj-control-group"><label><?php _e( 'Y Offset (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="buttons[secondary][shadow][y]" value="<?php echo esc_attr( $btn_secondary_options['shadow']['y'] ?? '' ); ?>" placeholder="10"></div><div class="jj-control-group"><label><?php _e( 'Blur (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="buttons[secondary][shadow][blur]" value="<?php echo esc_attr( $btn_secondary_options['shadow']['blur'] ?? '' ); ?>" placeholder="15"></div><div class="jj-control-group"><label><?php _e( 'Spread (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="buttons[secondary][shadow][spread]" value="<?php echo esc_attr( $btn_secondary_options['shadow']['spread'] ?? '' ); ?>" placeholder="-5"></div></div>
                    </fieldset>
                </div>
            </div>
        </div>
        ...
        <div class="jj-tab-content <?php echo ( $first_enabled_tab === 'btn-text' ) ? 'is-active' : ''; ?>" data-tab-content="btn-text">
             <div class="jj-button-preview-grid">
                <div class="jj-button-preview">
                    <a href="#" class="jj-button-preview-btn jj-preview-text" onclick="return false;"><?php _e( 'Text Button', 'jj-style-guide' ); ?></a>
                </div>
                ...
                <div class="jj-button-controls">
                    ...
                    <fieldset class="jj-control-group jj-fieldset-group jj-grid-2-col"><legend><?php _e( 'Layout', 'jj-style-guide' ); ?></legend>
                        <div class="jj-control-group"><label for="jj-btn-text-border-radius"><?php _e( 'Border Radius (px)', 'jj-style-guide' ); ?></label><input type="number" id="jj-btn-text-border-radius" class="jj-data-field" data-setting-key="buttons[text][border_radius]" value="<?php echo esc_attr( $btn_text_options['border_radius'] ?? '' ); ?>" placeholder="예: 4" /></div>
                    ...
                    <fieldset class="jj-control-group jj-fieldset-group"><legend><?php _e( 'Button Shadow', 'jj-style-guide' ); ?></legend>
                        <div class="jj-shadow-group"><div class="jj-control-group"><label><?php _e( 'Color', 'jj-style-guide' ); ?></label><input type="text" class="jj-color-field jj-data-field" data-setting-key="buttons[text][shadow][color]" value="<?php echo esc_attr( $btn_text_options['shadow']['color'] ?? '' ); ?>" /></div><div class="jj-control-group"><label><?php _e( 'X Offset (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="buttons[text][shadow][x]" value="<?php echo esc_attr( $btn_text_options['shadow']['x'] ?? '' ); ?>" placeholder="0"></div><div class="jj-control-group"><label><?php _e( 'Y Offset (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="buttons[text][shadow][y]" value="<?php echo esc_attr( $btn_text_options['shadow']['y'] ?? '' ); ?>" placeholder="10"></div><div class="jj-control-group"><label><?php _e( 'Blur (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="buttons[text][shadow][blur]" value="<?php echo esc_attr( $btn_text_options['shadow']['blur'] ?? '' ); ?>" placeholder="15"></div><div class="jj-control-group"><label><?php _e( 'Spread (px)', 'jj-style-guide' ); ?></label><input type="number" class="jj-data-field" data-setting-key="buttons[text][shadow][spread]" value="<?php echo esc_attr( $btn_text_options['shadow']['spread'] ?? '' ); ?>" placeholder="-5"></div></div>
                    </fieldset>
                </div>
            </div>
        </div>
