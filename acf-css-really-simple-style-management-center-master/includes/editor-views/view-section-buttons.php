...
<div class="jj-section-global" id="jj-section-buttons">
    ...
    <div class="jj-tabs-container">
        ...
        <div class="jj-tab-content <?php echo ( $first_enabled_tab === 'btn-primary' ) ? 'is-active' : ''; ?>" data-tab-content="btn-primary">
            ...
            <div class="jj-tab-quick-nav" style="margin-bottom: 20px;">
                <ul class="jj-tab-quick-nav-list">
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-primary-colors" class="jj-tab-quick-nav-link"><?php _e( 'Colors', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-primary-layout" class="jj-tab-quick-nav-link"><?php _e( 'Layout', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-primary-shadow" class="jj-tab-quick-nav-link"><?php _e( 'Button Shadow', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                </ul>
            </div>
            ...
            <div class="jj-button-preview-grid">
                ...
                <div class="jj-button-controls">
                    <fieldset class="jj-control-group jj-fieldset-group jj-section-subsection" id="jj-btn-primary-colors">
        ...
        <div class="jj-tab-content <?php echo ( $first_enabled_tab === 'btn-secondary' ) ? 'is-active' : ''; ?>" data-tab-content="btn-secondary">
            ...
            <div class="jj-tab-quick-nav" style="margin-bottom: 20px;">
                <ul class="jj-tab-quick-nav-list">
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-secondary-colors" class="jj-tab-quick-nav-link"><?php _e( 'Colors', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-secondary-layout" class="jj-tab-quick-nav-link"><?php _e( 'Layout', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-secondary-shadow" class="jj-tab-quick-nav-link"><?php _e( 'Button Shadow', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                </ul>
            </div>
            ...
            <div class="jj-button-preview-grid">
                ...
                <div class="jj-button-controls">
                    <fieldset class="jj-control-group jj-fieldset-group jj-section-subsection" id="jj-btn-secondary-colors">
                        <legend><?php _e( 'Colors', 'acf-css-really-simple-style-management-center' ); ?></legend>
                    ...
                    <fieldset class="jj-control-group jj-fieldset-group jj-grid-2-col jj-section-subsection" id="jj-btn-secondary-layout"><legend><?php _e( 'Layout', 'acf-css-really-simple-style-management-center' ); ?></legend>
                    ...
                    <fieldset class="jj-control-group jj-fieldset-group jj-section-subsection" id="jj-btn-secondary-shadow"><legend><?php _e( 'Button Shadow', 'acf-css-really-simple-style-management-center' ); ?></legend>
        ...
        <div class="jj-tab-content <?php echo ( $first_enabled_tab === 'btn-text' ) ? 'is-active' : ''; ?>" data-tab-content="btn-text">
            ...
            <div class="jj-tab-quick-nav" style="margin-bottom: 20px;">
                <ul class="jj-tab-quick-nav-list">
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-text-colors" class="jj-tab-quick-nav-link"><?php _e( 'Colors', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-text-layout" class="jj-tab-quick-nav-link"><?php _e( 'Layout', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                    <li class="jj-tab-quick-nav-item"><a href="#jj-btn-text-shadow" class="jj-tab-quick-nav-link"><?php _e( 'Button Shadow', 'acf-css-really-simple-style-management-center' ); ?></a></li>
                </ul>
            </div>
             ...
             <div class="jj-button-preview-grid">
                ...
                <div class="jj-button-controls">
                    <fieldset class="jj-control-group jj-fieldset-group jj-section-subsection" id="jj-btn-text-colors">
                        <legend><?php _e( 'Colors', 'acf-css-really-simple-style-management-center' ); ?></legend>
                    ...
                    <fieldset class="jj-control-group jj-fieldset-group jj-grid-2-col jj-section-subsection" id="jj-btn-text-layout"><legend><?php _e( 'Layout', 'acf-css-really-simple-style-management-center' ); ?></legend>
                    ...
                    <fieldset class="jj-control-group jj-fieldset-group jj-section-subsection" id="jj-btn-text-shadow"><legend><?php _e( 'Button Shadow', 'acf-css-really-simple-style-management-center' ); ?></legend>
