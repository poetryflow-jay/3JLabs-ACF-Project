...
<div class="jj-tab-content" data-tab-content="temp-palette">
    <div class="jj-temp-palette-header">
        <h3><?php _e( '임시 팔레트', 'jj-style-guide' ); ?></h3>
        <p class="description">
            <?php _e( '이 영역에는 스타일 가이드 설정 페이지에서 저장된 임시 팔레트 값이 표시됩니다.', 'jj-style-guide' ); ?>
            <br>
            <?php _e( '아래 버튼을 사용하여 현재 브랜드 팔레트를 임시 팔레트로 저장하거나, 임시 팔레트를 1. 브랜드 팔레트로 적용할 수 있습니다.', 'jj-style-guide' ); ?>
            <br>
            <a href="<?php echo esc_url( admin_url( 'post.php?post=' . ( isset( $cockpit_page_id ) ? $cockpit_page_id : get_option( JJ_STYLE_GUIDE_COCKPIT_PAGE_ID_KEY, 0 ) ) . '&action=edit' ) ); ?>" target="_blank">
                <?php _e( '스타일 가이드 설정 페이지 열기 (새 탭)', 'jj-style-guide' ); ?>
            </a>
        </p>
    </div>

    <fieldset class="jj-fieldset-group">
        <legend><?php _e( '임시 브랜드 팔레트', 'jj-style-guide' ); ?></legend>
        <div class="jj-style-guide-grid jj-grid-4-col">
            
            <div class="jj-control-group jj-temp-palette-preview">
                <label><?php _e( 'Primary Color', 'jj-style-guide' ); ?></label>
            ...
            <div class="jj-control-group jj-temp-palette-preview">
                <label><?php _e( 'Primary (Hover)', 'jj-style-guide' ); ?></label>
            ...
            <div class="jj-control-group jj-temp-palette-preview">
                <label><?php _e( 'Secondary Color', 'jj-style-guide' ); ?></label>
            ...
            <div class="jj-control-group jj-temp-palette-preview">
                <label><?php _e( 'Secondary (Hover)', 'jj-style-guide' ); ?></label>
        ...
        <div class="jj-apply-palette-actions">
            <button type="button" 
                ...
                <?php _e( '현재 브랜드 팔레트를 임시 팔레트로 저장', 'jj-style-guide' ); ?>
            </button>
            <button type="button" 
                    class="button button-primary jj-apply-palette-button" 
                    data-apply-target="brand">
                <?php _e( '임시 팔레트를 1. 브랜드 팔레트로 적용', 'jj-style-guide' ); ?>
            </button>
            <span class="spinner"></span>
            <p class="description">
                <?php _e( '임시 저장은 실험용 팔레트를 보관하는 용도로 사용되며, 적용 버튼을 누르기 전까지 기존 브랜드 팔레트 값은 변경되지 않습니다.', 'jj-style-guide' ); ?>
            </p>
        </div>
