<?php
/**
 * Plugin Name:       ACF CSS - Advanced Custom Fonts & Colors & Styles Setting Manager - Partner Edition
...
if ( ! defined( 'JJ_STYLE_GUIDE_VERSION' ) ) {
    define( 'JJ_STYLE_GUIDE_VERSION', '13.3.0' ); // [v13.3.0] Phase 15: Local WordPress Environment + Plugin Header Updates
}
...
if ( ! defined( 'JJ_STYLE_GUIDE_LICENSE_TYPE' ) ) define( 'JJ_STYLE_GUIDE_LICENSE_TYPE', 'UNLIMITED' );
if ( ! defined( 'JJ_STYLE_GUIDE_EDITION' ) ) define( 'JJ_STYLE_GUIDE_EDITION', 'unlimited' );
define( 'JJ_STYLE_GUIDE_USER_TYPE', 'PARTNER' );
