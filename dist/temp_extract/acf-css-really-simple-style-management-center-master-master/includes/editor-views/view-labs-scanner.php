...
<div class="jj-labs-scanner-tab">
    <h2><?php _e( 'CSS/HTML/JS 스캐너', 'acf-css-really-simple-style-management-center' ); ?></h2>
    <p class="description jj-labs-tab-description" data-tab-type="scanner" data-tooltip="labs-tab-scanner">
        <?php _e( '분석하고 싶은 페이지의 URL을 입력하거나, 활성 플러그인/테마 목록에서 대상을 선택한 뒤 스캔을 시작하세요. CSS 선택자, HTML 구조, JavaScript 정보를 추출하여 표시합니다.', 'acf-css-really-simple-style-management-center' ); ?>
    ...
    <div class="jj-style-guide-grid jj-grid-2-col" style="margin-top: 20px;">
        ...
        <div class="jj-control-group">
            <label for="jj-labs-scan-url">
                <strong><?php _e( 'URL로 스캔하기', 'acf-css-really-simple-style-management-center' ); ?></strong>
            </label>
            <input type="url" 
                   id="jj-labs-scan-url" 
                   class="jj-data-field" 
            ...
            <button type="button" class="button button-primary" id="jj-labs-start-scan-url" style="margin-top: 10px;">
                <?php _e( '분석 시작', 'acf-css-really-simple-style-management-center' ); ?>
            </button>
        ...
        <div class="jj-control-group">
            <label for="jj-labs-scan-target">
                <strong><?php _e( '활성 플러그인/테마로 스캔하기', 'acf-css-really-simple-style-management-center' ); ?></strong>
            </label>
            ...
            <p class="description" style="margin-top: 8px;">
                <?php _e( '현재 활성 테마 또는 플러그인을 선택하면, 해당 리소스의 스타일 구조를 파악하는 데 도움이 되는 기본 정보를 함께 확인하실 수 있습니다.', 'acf-css-really-simple-style-management-center' ); ?>
            </p>
        </div>
    </div>
    ...
    <div class="jj-labs-scan-results" id="jj-labs-scan-results" style="margin-top: 30px;">
        <h3><?php _e( '분석 결과', 'acf-css-really-simple-style-management-center' ); ?></h3>
        <div class="jj-labs-results-empty" style="padding: 40px; text-align: center; background: #f9f9f9; border: 1px dashed #c3c4c7; border-radius: 4px;">
            <p class="description" style="color: #8c8f94;">
                <?php _e( '분석이 완료되면, CSS 선택자 목록, HTML 구조, JavaScript 정보가 이 영역에 표시됩니다.', 'acf-css-really-simple-style-management-center' ); ?>
            </p>
        </div>
        ...
        <div class="jj-labs-results-tabs" style="display: none; margin-top: 20px;">
            <div class="jj-tabs-nav">
                <button type="button" class="jj-tab-button is-active" data-tab="results-css">
                    <?php _e( 'CSS 선택자', 'acf-css-really-simple-style-management-center' ); ?>
                </button>
                <button type="button" class="jj-tab-button" data-tab="results-html">
                    <?php _e( 'HTML 구조', 'acf-css-really-simple-style-management-center' ); ?>
                </button>
                <button type="button" class="jj-tab-button" data-tab="results-js">
                    <?php _e( 'JavaScript', 'acf-css-really-simple-style-management-center' ); ?>
                </button>
            </div>
                ...
                <div class="jj-labs-results-css">
                    ...
                    <div id="jj-labs-scan-insights" style="display: none; margin-bottom: 25px; padding: 15px; background: #f0f6fc; border: 1px solid #c3c4c7; border-radius: 4px;">
                        <h4 style="margin-top: 0; margin-bottom: 15px;">
                            ...
                            <?php _e( '스캔 인사이트', 'acf-css-really-simple-style-management-center' ); ?>
                        </h4>
                        
                        <!-- 추출된 색상 -->
                        <div id="jj-labs-extracted-colors" style="display: none; margin-bottom: 15px;">
                            <strong><?php _e( '추출된 색상', 'acf-css-really-simple-style-management-center' ); ?>:</strong>
                            ...
                            <button type="button" class="button button-small" id="jj-labs-apply-colors" style="margin-top: 10px; display: none;">
                                <?php _e( '상위 색상을 브랜드 팔레트에 적용', 'acf-css-really-simple-style-management-center' ); ?>
                            </button>
                        </div>
                        
                        <!-- 추출된 폰트 -->
                        <div id="jj-labs-extracted-fonts" style="display: none; margin-bottom: 15px;">
                            <strong><?php _e( '추출된 폰트', 'acf-css-really-simple-style-management-center' ); ?>:</strong>
                            ...
                            <button type="button" class="button button-small" id="jj-labs-apply-fonts" style="margin-top: 10px; display: none;">
                                <?php _e( '상위 폰트를 타이포그래피에 적용', 'acf-css-really-simple-style-management-center' ); ?>
                            </button>
                        </div>
                        
                        <!-- 충돌/문제점 -->
                        <div id="jj-labs-conflicts" style="display: none; margin-top: 15px;">
                            <strong><?php _e( '감지된 문제점', 'acf-css-really-simple-style-management-center' ); ?>:</strong>
                    ...
                    <div style="margin-bottom: 15px;">
                        <strong><?php _e( 'Class 선택자', 'acf-css-really-simple-style-management-center' ); ?></strong>
                    ...
                    <div style="margin-top: 20px;">
                        <strong><?php _e( 'ID 선택자', 'acf-css-really-simple-style-management-center' ); ?></strong>
                    ...
                    <div style="margin-top: 20px;">
                        <strong><?php _e( '발견된 CSS 스타일 블록', 'acf-css-really-simple-style-management-center' ); ?></strong>
                    </div>
            ...
            <div class="jj-tab-content" data-tab-content="results-html">
                <div class="jj-labs-results-html">
                    <div style="margin-bottom: 15px;">
                        <strong><?php _e( 'HTML 구조 미리보기', 'acf-css-really-simple-style-management-center' ); ?></strong>
                        <p class="description"><?php _e( '스캔한 페이지의 HTML 구조 일부입니다. (처음 2000자)', 'acf-css-really-simple-style-management-center' ); ?></p>
                    </div>
            ...
            <div class="jj-tab-content" data-tab-content="results-js">
                <div class="jj-labs-results-js">
                    <div style="margin-bottom: 15px;">
                        <strong><?php _e( 'JavaScript 정보', 'acf-css-really-simple-style-management-center' ); ?></strong>
                        <p class="description"><?php _e( '스캔한 페이지에서 발견된 JavaScript 파일 및 인라인 스크립트 정보입니다.', 'acf-css-really-simple-style-management-center' ); ?></p>
                    </div>
