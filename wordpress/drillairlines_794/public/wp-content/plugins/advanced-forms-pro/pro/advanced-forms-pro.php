...
class AF_Pro {
	...
	function initialize() {
		...
		AF()->classes['pro_core_recaptcha'] = include( plugin_dir_path( __FILE__ ) . '/core/integrations/core-recaptcha.php' );
		AF()->classes['pro_core_calculated'] = include( plugin_dir_path( __FILE__ ) . '/core/core-calculated.php' );
		AF()->classes['pro_core_restrictions'] = include( plugin_dir_path( __FILE__ ) . '/core/core-restrictions.php' );
		AF()->classes['pro_core_gutenberg'] = include( plugin_dir_path( __FILE__ ) . '/core/core-gutenberg.php' );
		AF()->classes['pro_core_migrations'] = include( plugin_dir_path( __FILE__ ) . '/core/core-migrations.php' );

		// ACF additions
		include( plugin_dir_path( __FILE__ ) . '/acf/fields/calculated.php' );
		include( plugin_dir_path( __FILE__ ) . '/acf/fields/af-calculated-admin.php' );
		...
		AF()->classes['pro_admin_restrictions'] = include( plugin_dir_path( __FILE__ ) . '/admin/admin-restrictions.php' );
	}
