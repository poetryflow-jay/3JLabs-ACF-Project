...
class WC_Gateway_Portone_Card extends PORTONE_Payment_Gateway {
	...
	public function __construct() {
		...
		//settings
		$this->method_title       = __( '포트원(신용카드)', 'iamport-for-woocommerce' );
		...
		$this->form_fields = array_merge(
			array(
				'enabled'     => array(
					...
					'type'    => 'checkbox',
					'label'   => __( '포트원(신용카드) 결제 사용', 'iamport-for-woocommerce' ),
					'default' => 'yes'
				),
				'title'       => array(
			...
			array(
				'_pg_auto_title'   => array(
					'title'       => __( '(1) 신용카드 결제 시, 자동 적용될 PG설정값 세팅', 'iamport-for-woocommerce' ),
					'type'        => 'title',
				...
				'_pg_manual_title' => array(
					'title'       => __( '(2) 신용카드 결제 시, 적용될 PG설정값을 고객이 직접 지정', 'iamport-for-woocommerce' ),
					'type'        => 'title',
				...
				'use_manual_pg'    => array(
					...
					'type'        => 'checkbox',
					'description' => __( '포트원 계정에 설정된 여러 PG사 / MID를 사용자의 선택에 따라 적용하는 기능을 활성화합니다. 신용카드 결제수단 선택 시, 세부 결제수단 선택창이 추가로 출력됩니다.', 'iamport-for-woocommerce' ),
					'default'     => 'no',
				),
				'manual_pg_id'     => array(
	...
	public function iamport_order_detail( $order_id ) {
        ...
        <table class="shop_table order_details">
            ...
            <tr>
                ...
                <td><?php esc_html_e( '신용카드', 'iamport-for-woocommerce' ) ?></td>
            </tr>
            <tr>
