...
2. Search for <strong>'Nexter Blocks'</strong> and install it
3. Now You will have all the Blocks available in your Block Library. You can easily add them using the ‘Add Block’ button in your page editor.
4. You may enable/disable Blocks from Nexter Dashboard.
5. Congratulations, Now your site is ⚡ SUPERCHARGED, Get ready to build amazing websites
...
1. All-in-One WordPress 90+ WordPress Blocks Collections
2. 1000+ Ready to Use WordPress Templates & Sections
3. Horizontal & Vertical Mega Menu Builder
4. Popup, Modal & Off Canvas Builder for Sale & Advertisement
5. Login Form, Register Form & Forgot Password Form Maker
6. Facebook, Instagram, Twitter, YouTube, Vimeo Feeds
7. Image & Video Gallery (Grid, Carousel, Masonry) with Category Filters
8. Advanced Dynamic Display & Visibility Controls for Blocks
9. Responsive Data Tables with Search, Sort & Filters
10. Most Advanced Carousel Slider with Remote Connection with Accordion, Tabs, etc.
