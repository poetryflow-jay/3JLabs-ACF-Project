...
class AF_Pro_Admin_Integrations {
	...
	function add_form_settings_fields( $field_group ) {
		...
		// reCAPTCHA
		$field_group['fields'][] = array(
			'key' => 'field_form_integrations_recaptcha',
			'label' => sprintf( '<img src="%s" />Google reCAPTCHA', AF()->url . 'pro/assets/images/recaptcha_logo.png' ),
			'name' => 'form_integrations_recaptcha',
			'type' => 'true_false',
			'instructions' => 'Protect your form against spam using an invisible captcha.',
			'ui' => 1,
			'ui_on_text' => 'Enabled',
			'ui_off_text' => 'Disabled',
		);

		if ( empty( AF_Pro_Core_Recaptcha::get_site_key() ) || empty( AF_Pro_Core_Recaptcha::get_secret_key() ) ) {
			$field_group['fields'][] = array(
				'key' => 'field_form_recaptcha_missing_keys',
				'label' => 'Missing keys',
				'name' => 'form_recaptcha_missing_keys',
				'type' => 'message',
				'message' => 'Go to Forms &rarr; Settings to enter a reCAPTCHA site and secret key. Read the documentation to <a href="https://advancedforms.github.io/pro/integrations/configuring-google-recaptcha/">learn how to get your keys</a>.',
				'required' => 0,
				'conditional_logic' => array(
					array (
						array (
							'field' => 'field_form_integrations_recaptcha',
							'operator' => '==',
							'value' => '1',
						),
					),
	...
	function add_general_settings_fields( $field_group ) {
		...
		$field_group['fields'][] = array (
			...
			'label' => sprintf( '<img src="%s" />Mailchimp API Key', AF()->url . 'pro/assets/images/mailchimp_logo.png' ),
			'name' => 'af_mailchimp_api_key',
			'type' => 'password',
			'instructions' => sprintf( 'Read our <a href="%s">guide</a> on how to create an API key', 'https://advancedforms.github.io/pro/configuration/configuring-mailchimp/' ),
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
		...
		$field_group['fields'][] = array(
			'key' => 'field_af_settings_mailchimp_divider',
			'name' => 'Mailchimp divider',
			'type' => 'divider',
		);
    ...
    $field_group['fields'][] = array (
      'key' => 'field_af_recaptcha',
      'label' => sprintf( '<img src="%s" /> Google reCAPTCHA', AF()->url . 'pro/assets/images/recaptcha_logo.png' ),
      'name' => 'af_recaptcha',
      'type' => 'message',
			'message' => sprintf( 'Read our <a href="%s">guide</a> to learn how to get a site and secret key', 'https://advancedforms.github.io/pro/integrations/configuring-google-recaptcha/' ),
      'required' => 0,
    );

    $field_group['fields'][] = array(
      'key' => 'field_af_recaptcha_site_key',
      'label' => 'Site Key',
      'name' => 'field_af_recaptcha_site_key',
      'type' => 'password',
      'wrapper' => array(
        'width' => '50',
      ),
    ...
    $field_group['fields'][] = array(
      'key' => 'field_af_recaptcha_secret_key',
      'label' => 'Secret Key',
      'name' => 'field_af_recaptcha_secret_key',
      'type' => 'password',
      'wrapper' => array(
        'width' => '50',
      ),
