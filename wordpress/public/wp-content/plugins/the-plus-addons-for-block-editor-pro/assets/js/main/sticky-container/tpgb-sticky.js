...
var tpgbheadersticky = function(el,initOff){
    ...
    var resData = JSON.parse(el.dataset.stickyOpt),
        ...
        if(resData.scupSticky){
            ...
            mobCheck = resData && resData.xs && window.innerWidth < 768 && window.scrollY > scrollTop + ( resData.topoff && resData.topoff.xs ? (Number(resData.topoff.xs) - barOfset) : (-barOfset)  )
        }
