...
function tpgb_tp_login_render_callback( $attributes, $content) {
	...
	if($formType == 'register' || $formType == 'login-register'){
		...
		$rehtmlTxt = htmlspecialchars(wp_json_encode($rehtmlTxt), ENT_QUOTES, 'UTF-8');
	...
	if($formType == 'login' || $formType == 'login-register'){
		...
		$loginhtmlTxt = htmlspecialchars(wp_json_encode($loginhtmlTxt), ENT_QUOTES, 'UTF-8');
	...
	if($formType == 'login' || $formType == 'login-register' || $formType == 'forgot_password' ){
		...
		$lostpasshtmlTxt['cumData'] = Tpgbp_Pro_Blocks_Helper::tpgb_simple_decrypt( htmlspecialchars(wp_json_encode($cusData), ENT_QUOTES, 'UTF-8') , 'ey');

		$lostpasshtmlTxt = htmlspecialchars(wp_json_encode($lostpasshtmlTxt), ENT_QUOTES, 'UTF-8');
...
function tpgb_tp_login() {
	...
	// 		],
	// 		'default' => [ 
	// 			[ '_key' => '0' , 'loginfName' => 'username', 'FieldLabel' => 'Username' , 'placeholder' => 'Enter Username' , 'fieldWidth' => ["unit" => '%' , 'md' => ''] , 'googlThm' => 'outline' , 'googloTitle' => false , 'googlePic' => false , 'LfobtniPosi' => 'before' , 'gbtnType' => 'standard' , 'gostandshape' => 'rectangular' , 'gobtnTxt' => 'signin_with' , 'gobctmTxt' => '' , 'gobtnSize' => 'large' , 'gobctWidth' => '' , 'goioshape' => 'square' , 'goioSize' => 'large' ,'soctmUrl' => [ 'url' => '#' ] ,'regisUrl' => [ 'url' => '#' ] ],
	// 			[ '_key' => '1' , 'loginfName' => 'password', 'FieldLabel' => 'Password' , 'placeholder' => 'Enter Password' , 'fieldWidth' => ["unit" => '%' , 'md' => ''] , 'googlThm' => 'outline' , 'googloTitle' => false , 'googlePic' => false , 'LfobtniPosi' => 'before' , 'gbtnType' => 'standard' , 'gostandshape' => 'rectangular' , 'gobtnTxt' => 'signin_with' , 'gobctmTxt' => '' , 'gobtnSize' => 'large' , 'gobctWidth' => '' , 'goioshape' => 'square' , 'goioSize' => 'large' ,'soctmUrl' => [ 'url' => '#' ] ,'regisUrl' => [ 'url' => '#' ] ],
	// 			[ '_key' => '2' , 'loginfName' => 'remember-me', 'content' => 'Remember Me' ,'fieldWidth' => ["unit" => '%' , 'md' => ''] , 'googlThm' => 'outline' , 'googloTitle' => false , 'googlePic' => false , 'LfobtniPosi' => 'before' , 'gbtnType' => 'standard' , 'gostandshape' => 'rectangular' , 'gobtnTxt' => 'signin_with' , 'gobctmTxt' => '' , 'gobtnSize' => 'large' , 'gobctWidth' => '' , 'goioshape' => 'square' , 'goioSize' => 'large' ,'soctmUrl' => [ 'url' => '#' ] ,'regisUrl' => [ 'url' => '#' ] ],
	// 			[ '_key' => '3' , 'loginfName' => 'lost-password', 'content' => 'Lost Password' , 'LfobtniPosi' => 'before' , 'gbtnType' => 'standard' , 'gostandshape' => 'rectangular' , 'gobtnTxt' => 'signin_with' , 'gobctmTxt' => '' , 'gobtnSize' => 'large' , 'gobctWidth' => '' , 'goioshape' => 'square' , 'goioSize' => 'large' ,'soctmUrl' => [ 'url' => '#' ] ,'regisUrl' => [ 'url' => '#' ] ],
	// 			[ '_key' => '4' , 'loginfName' => 'login-button', 'content' => 'Log In' , 'fieldWidth' => ["unit" => '%' , 'md' => ''] , 'googlThm' => 'outline' , 'googloTitle' => false , 'googlePic' => false , 'LfobtniPosi' => 'before' , 'gbtnType' => 'standard' , 'gostandshape' => 'rectangular' , 'gobtnTxt' => 'signin_with' , 'gobctmTxt' => '' , 'gobtnSize' => 'large' , 'gobctWidth' => '' , 'goioshape' => 'square' , 'goioSize' => 'large' ,'soctmUrl' => [ 'url' => '#' ] ,'regisUrl' => [ 'url' => '#' ] ]
	// 		],
	// 	],
	// 	'loglodTxt' => [
	// 		'type' => 'string',
	...
	// 			(object) [
	// 				'condition' => [(object) [ 'key' => 'formType', 'relation' => '==', 'value' => [ 'login-register' , 'login' ]]],
	// 				'selector' => '{{PLUS_WRAP}} .tpgb-field-group.tpgb-lostpass-relink{ text-align : {{lostxtAlign}} }',
	// 			],
	// 		],
	// 	],
	// 	'losttxtColor' => [
    ...
    if(method_exists('Tpgb_Blocks_Global_Options', 'merge_options_json')){
		$block_data = Tpgb_Blocks_Global_Options::merge_options_json(__DIR__, 'tpgb_tp_login_render_callback');
				...
				if(!empty($LField['loginfName'])){
					...
					if($LField['loginfName'] == 'lost-password' || $LField['loginfName'] == 'register' || $LField['loginfName'] == 'magic-link'){
						...
						if($LField['loginfName'] == 'magic-link'){
							$loginForm .= '<a class="tpgb-magic-tag" href="#" aria-label="'.(!empty($LField['content']) ? esc_attr($LField['content']) : esc_attr__('Magic Link','tpgbp')).'" > '.(!empty($LField['content']) ? esc_html($LField['content']) : esc_html__('Magic Link','tpgbp')).' </a>';
...
function tpgb_getSocialbtn($solayout , $facebooklog , $faceAppid , $faceSecid , $googlelog , $googlId , $redirUrl , $fType , $googlThm , $googlePic , $id , $gbtnType , $gostandshape , $gobtnTxt , $gobtnSize , $gobctWidth , $goioshape , $goioSize ){
	...
	$socialId = [
		...
		'faceSecid' => (!empty($faceSecid)) ? Tpgbp_Pro_Blocks_Helper::tpgb_simple_decrypt( wp_json_encode($faceSecid), 'ey' ) : '',
	...
	$socialId = wp_json_encode($socialId);
...
function tpgb_getforgetform($Label , $placeholder , $key , $title , $lobtntxt , $lostClass , $name , $data , $bIcon , $block_id , $lorecap , $lobtnIcon ){
	...
	if($name == 'magic' && !empty($data)){
		$mdataAtrr = Tpgbp_Pro_Blocks_Helper::tpgb_simple_decrypt( wp_json_encode($data), 'ey');
		$mdataAtrr = htmlspecialchars(wp_json_encode($mdataAtrr), ENT_QUOTES, 'UTF-8');
...
function tpgb_getlostpass_form($stpassreq,$losrecaptch,$block_id , $reCaptch_key,$lorecaposition){
	...
	if(!empty($attributes)){
		...
		$forgotreskey['resetpdata'] = Tpgbp_Pro_Blocks_Helper::tpgb_simple_decrypt( wp_json_encode($forgotres), 'ey' );


		$redataAttr = 'data-lostpassData=\'' .htmlspecialchars(wp_json_encode($forgotreskey), ENT_QUOTES, 'UTF-8'). '\' ';
