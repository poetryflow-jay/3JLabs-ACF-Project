...
class TPGBP_Pro_Init_Blocks {
    ...
    public function editor_assets() {
		...
		wp_set_script_translations( 'tpgb-block-editor-js', 'the-plus-addons-for-block-editor' , TPGBP_PATH . '/languages/' );
    }
					...
					switch ( $params['field']['dynamicUrl'] ) {
						...
						case 'site-logo':
							...
							if ( $custom_logo_id ) {
                                ...
                                $outputImg['url'] = TPGBP_URL.'assets/images/tpdb-placeholder.jpg';
                            }
						break;
	...
	public function tp_get_repeater_data($request) {
        ...
        // Handle ACF Repeater
        if ( str_starts_with($field_name, 'acf|') && function_exists('get_field_object') ) {
